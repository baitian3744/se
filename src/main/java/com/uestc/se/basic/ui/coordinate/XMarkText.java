 ...
 *
 */
public class XMarkText implements Graphic{
...
//	private boolean enable;
	...
	public XMarkText(String txt) {
		this(txt, new Point(0.0f, 0.0f, 0.0f));
	}
	
	public XMarkText(String txt, Point position){
		this(txt, position, Color.white);
	}
	
	public XMarkText(String txt, Point position, Color color){
		this.text = txt;
	...
	public void draw() {
		GL11.glPushMatrix();
	    	GL11.glDisable(GL11.GL_LIGHTING);
		    	...
		    	TextPrinter.eprintCentTop(0.0f, 0.0f, this.text, color);
