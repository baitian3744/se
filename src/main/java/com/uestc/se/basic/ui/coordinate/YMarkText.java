 ...
 *
 */
public class YMarkText implements Graphic{
...
//	private boolean enable;
	...
	public YMarkText(String txt) {
		this(txt, new Point(0.0f, 0.0f, 0.0f));
	}
	
	public YMarkText(String txt, Point position){
		this(txt, position, Color.white);
	}
	
	public YMarkText(String txt, Point position, Color color){
		this.text = txt;
	...
	public void draw() {
		GL11.glPushMatrix();
	    	GL11.glDisable(GL11.GL_LIGHTING);
		    	...
		    	TextPrinter.eprintBtmRight(0.0f, 0.0f, this.text, color);
